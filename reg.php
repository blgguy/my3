...
if (isset($_POST['signup-submit'])) {
    ...
    $query = "Insert INTO demographics(PatientID,Title,FirstName,MiddleName,LastName,Gender,DateOfBirth,BloodType,EmailID,Designation,InsuranceNumber) 
    VALUES ('$PatientID','$Title','$FirstName','$MiddleName','$LastName','$Gender','$DateOfBirth','$BloodType','$EmailID','$Designation','$InsuranceNumber')";
